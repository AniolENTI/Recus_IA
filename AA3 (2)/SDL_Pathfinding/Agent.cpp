...
void Agent::setPathfinding(Pathfinding* pathfinding)
{
	this->pathfinding = pathfinding;
}

void Agent::FindPath(Vector2D pos)
{
	if (getPathSize() > 0)
		pathfinding->FindPath(this, pos, getPathPoint(getPathSize() - 1));

	else
		pathfinding->FindPath(this, pos, position);
}
